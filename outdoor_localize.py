...
images = Path("datasets/Outdoor/db/")
outputs = Path("outputs/Outdoor/")
...
def localize_outdoor(query_parent_path:Path,query_name:str):
...
def main():
    ...
    localize_outdoor(Path(args.folder_query),args.query_name)
